...
namespace halconwpf01.ViewModel
{
    ...
    {
       public  HWindowControlWPF h1 { get; set; }
        ...
        private void initMethod()
        {
            ...
            h1.HalconWindow.SetPart(0, 0, height.D, width.D);//:“HALCON error #2453: HALCON handle is NULL in operator set_part”
            h1.HalconWindow.DispObj(ho_Heisi);
        }
        private void RgbToGrayMethod()
        {
            HOperatorSet.Rgb1ToGray(ho_Heisi, out ho_grayimg);
            h1.HalconWindow.DispObj(ho_grayimg);
        }
        private void ThreSholdMethod()
        {
            HOperatorSet.Threshold(ho_grayimg, out ho_Regions, 4, 110);
            h1.HalconWindow.DispObj(ho_Regions);
        }
    }
}
